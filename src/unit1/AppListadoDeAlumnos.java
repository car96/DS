...
public class AppListadoDeAlumnos {
    ...
    public void crearAlumnos() {
        for (int i = 0; i < array.length; i++) {
            int yN = JOptionPane.showConfirmDialog(null, "Do you want to add a new student?", "Add subject", JOptionPane.YES_NO_OPTION);
            if (yN == 0) {
                ...
                for (int j = 0; j < array[i].array.length; j++) {
                    int yNS = JOptionPane.showConfirmDialog(null, "Do you want to add a new subject?", "Add student", JOptionPane.YES_NO_OPTION);
                    if (yNS == 0) {
